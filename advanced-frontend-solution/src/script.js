...
// (second parameter is default language)
...
// Normally you have to login and fetch the bearer token which
// you then store and use in subsequent requests. This method
// allows you to use a pre-supplied token instead.
client.updateAccessTokenDirectly(visitorToken);
// Retrieve the 'Boston' fabric
var fabric = await client.getFabric(10002);
